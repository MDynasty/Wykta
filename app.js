...
const uiMessages = {
  en: {
    ...
    aiUnavailable: "AI analysis unavailable. Results below are from open ingredient databases (OFF/OBF/Wikidata).",
  ...
  fr: {
    ...
    aiUnavailable: "Analyse IA indisponible. Les résultats ci-dessous proviennent des bases d'ingrédients ouvertes (OFF/OBF/Wikidata).",
